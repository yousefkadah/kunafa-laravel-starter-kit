<template>
  <div>
    <button
      ref="trigger"
      class="rounded-full"
      :class="dropdownOpen ? 'bg-slate-100 dark:bg-slate-700 text-slate-500 rounded-2xl dark:text-slate-400' : 'text-slate-400 hover:text-slate-500 dark:text-slate-500 dark:hover:text-slate-400'"
      aria-haspopup="true"
